...
//	public static String  YF_DESKLOAD="IS_DOWNLOAD";
	//public static String  YF_DESKFILENAME="YF_DESKFILENAME";
	
	public static String  YF_PROHIBIT_VER="PROHIBIT_VER";

	public static boolean YF_INSTALL=true;
	public static boolean YF_UNSTALL=false;
	public static int Nonslip = 2; //不可滑动的页面
	...
	public final static int MSG_PACKAGE_INSTALLED = 1;
	public final static int MSG_PACKAGE_UNINSTALLED = 2;
