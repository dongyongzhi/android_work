...
public class ElecDialog extends Dialog implements
	...
	public void setOkButton(int resid){
		((Button) findViewById(R.id.confirm_btn)).setText(resid);
	}
	...
	public void setCancelButton(int resid){
		((Button) findViewById(R.id.cancel_btn)).setText(resid);
	}
	...
	public static final class Builder {
		...
		public Builder setOkButton(int resid) {
			dialog.setOkButton(resid);
			return this;
		}

		public Builder setOkButton(CharSequence message) {
			dialog.setOkButton(message);
			return this;
		}
		
		public Builder setCancelButton(int resid) {
			dialog.setCancelButton(resid);
			return this;
		}

		public Builder setCancelButton(CharSequence message) {
			dialog.setCancelButton(message);
			return this;
		}
