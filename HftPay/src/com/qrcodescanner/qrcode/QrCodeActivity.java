package com.qrcodescanner.qrcode;
...
import com.hftcom.ui.pay.WxPayActivity;
import com.qrcodescanner.qrcode.camera.CameraManager;
import com.qrcodescanner.qrcode.decode.CaptureActivityHandler;
import com.qrcodescanner.qrcode.decode.DecodeImageCallback;
import com.qrcodescanner.qrcode.decode.DecodeImageThread;
import com.qrcodescanner.qrcode.decode.DecodeManager;
import com.qrcodescanner.qrcode.decode.InactivityTimer;
import com.qrcodescanner.qrcode.view.QrCodeFinderView;
...
//        mLlFlashLight.setVisibility(View.VISIBLE);
    ...
    private void handleResult(String resultString) {
        if (TextUtils.isEmpty(resultString)) {
        	...
        	if(resultString.matches("[0-9]+") && resultString.length() == 18){
	        	Intent intent = new Intent(QrCodeActivity.this,WxPayActivity.class);
	        	intent.putExtra("wxcode", resultString);
