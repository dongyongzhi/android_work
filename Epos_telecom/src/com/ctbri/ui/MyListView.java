...
public class MyListView extends ListView implements OnScrollListener
{
	...
	{
		count = 0;
		setCacheColorHint(context.getResources().getColor(R.color.trans));
	...
	public void addFooterView(View v)
	{
		...
		count++;
		// System.out.println("addFooterView===================="+count);
	}
	...
	public boolean removeFooterView(View v)
	{
		...
		// System.out.println("removeFooterView===================="+count);
		boolean b = super.removeFooterView(v);
		if (b)
			count--;
		return b;
	...
	public void onScroll(AbsListView arg0, int firstVisiableItem, int arg2, int arg3)
	{
		...
		lastItem = firstVisiableItem + arg2 - 2;
	}
	...
	public void onScrollStateChanged(AbsListView view, int scrollState)
	{
		...
		if (lastItem == (a.getCount() - 1 - count) && scrollState == OnScrollListener.SCROLL_STATE_IDLE)
		{
			if (refreshListener != null)
			{
				refreshListener.addDate();
			}
		}
	}
