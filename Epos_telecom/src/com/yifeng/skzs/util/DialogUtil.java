...
public class DialogUtil {
	 ...
	 * @param message  显示信息
	 */
	public static void dialog(Context ctx,String title,String message,final DialogInterface.OnClickListener onClickListener){
		...
		((Button) builder.findViewById(R.id.pBtn)).setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				onClickListener.onClick(builder, DialogInterface.BUTTON_POSITIVE);
			}
		});
		builder.setCanceledOnTouchOutside(false);// 设置点击Dialog外部任意区域关闭Dialog
		builder.show();
