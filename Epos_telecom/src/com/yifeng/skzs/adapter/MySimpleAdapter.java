...
public class MySimpleAdapter extends SimpleAdapter
{
	...
	public MySimpleAdapter(Context context, List<Map<String, Object>> data, int resource, String[] from, int[] to, Resources res)
	{
	...
	public boolean needEditBtn = false;// 是否需要详情按钮
	public String title;
