...
public final class NotificationService {
	...
	public final static String SERVICE_TRANS_MESSAGE = "com.ycomm.trans.message";
	 ...
	 */
	public void notificationTransStateChange(int state){
		if(context==null)
			return;
		Intent intent = new Intent(SERVICE_STATE_CHANGE);
		intent.putExtra(SERVICE_STATE, state);
		intent.putExtra(SERVICE_TYPE, SERVICE_TRANS_MESSAGE);
