...
public class QueryDayActivitys extends BaseActivity implements OnScrollListener,OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(QueryDayActivitys.this,
	...
	private void addData() {
		...
		if (SURPERDATA.size() > 0) {
			...
			if (state.equals("1")) {
				...
				listView.removeFooterView(commonUtil.loadingLayout);
				Toast.makeText(QueryDayActivitys.this,
