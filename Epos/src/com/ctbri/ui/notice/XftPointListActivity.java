 ...
 * @Date:2013-12-6
 */
public class XftPointListActivity extends BaseActivity implements OnScrollListener,OnTouchListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.xftpoint_list);
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				Intent intent = new Intent(XftPointListActivity.this,
						XftPotinDetailActivity.class);
		...
		this.setTitle(R.string.title_xftpoint);
		loadData();
	...
	private void addData() {
		...
		if (SURPERDATA.size() > 0) {
			...
			if (state.equals("1")) {
				...
				listView.removeFooterView(commonUtil.loadingLayout);
				Toast.makeText(XftPointListActivity.this,
