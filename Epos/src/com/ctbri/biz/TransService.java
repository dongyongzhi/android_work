...
public interface TransService {
	 ...
	 * @return           是否成功
	 */
	boolean sign(String operNo,String operPwd);
	 ...
	 * @return
	 */
	TransResponse  purchaseRefund(String managerPwd,String srcSerNo,String srcBatchNo,String srcReferenceNo,long money);
	 ...
	 */
	TransResponse revoke(String managerPwd,String srcSerNo,String srcBatchNo,String srcReferenceNo);
}
