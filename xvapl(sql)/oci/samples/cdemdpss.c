#ifdef RCSID
static char *RCSid =
   "$Header: cdemdpss.c 04-apr-2001.11:17:52 eegolf Exp $ ";
#endif /* RCSID */
...
struct obj inventory_stock_date =
{
  (text *) "sysdate", 0, 0, 0, 0, 0, 0, 0, OBJ_OPQ};



struct col  objx_02_col [] =
{
  {
...
struct obj name_str2 =
{
  (text *) "lower(add_months(sysdate, :name_str2_arg1))", 1,  objx_02_col,  objx_02_fld, 0, 0, 0, 0, OBJ_OPQ};
...
struct obj name_str =
{
  (text *) "substr(:name_str_arg1, :name_str_arg2, :name_str_arg3)", 3, objx_01_col, objx_01_fld, 0, 0, 0, 0, OBJ_OPQ};
