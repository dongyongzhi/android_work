#ifdef RCSID
static char *RCSid =
   "$Header: cdemdpin.c 04-apr-2001.11:17:46 eegolf Exp $ ";
#endif /* RCSID */
...
struct obj corporate_customer_typ =
{
  (text *) "CORPORATE_CUSTOMER_TYP", 2, objx_01_col, objx_01_fld, 0, 0, 0, 0, OBJ_OBJ};
