#ifdef RCSID
static char *RCSid =
   "$Header: cdemdpno.c 04-apr-2001.11:17:49 eegolf Exp $ ";
#endif /* RCSID */
...
struct obj warehouse_typ =
{
  (text *) "WAREHOUSE_TYP", 3, objx_02_col, objx_02_fld, 0, 0, 0, 0, OBJ_OBJ};
...
struct obj inventory_typ =
{
  (text *) "INVENTORY_TYP", 3, objx_01_col, objx_01_fld, 0, 0, 0, 0, OBJ_OBJ};
