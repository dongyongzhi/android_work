 ...
 * 
 */
public class UpdateAidActivity extends BaseActivity implements OnClickListener,OnCheckedChangeListener  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.updateaid);
	...
	private SimpleSwiperListener swiperListener = new SimpleSwiperListener() {
		...
		public void onError(int code, String messsage) {
			...
			new AlertDialog.Builder(UpdateAidActivity.this).setTitle("提示")
		...
		public void onResultSuccess(int nType) {
			progressDialog.dismiss();
			Toast.makeText(UpdateAidActivity.this, "执行成功", Toast.LENGTH_SHORT).show();
		}
	};
}
