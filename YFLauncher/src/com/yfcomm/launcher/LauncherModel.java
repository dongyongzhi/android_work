...
import com.yfcomm.launcher.InstallWidgetReceiver.WidgetMimeTypeHandlerData;
...
public class LauncherModel extends BroadcastReceiver {
    ...
    private class LoaderTask implements Runnable {
        ...
        public void run() {
            ...
            keep_running: {
            	...
            	//提高优先级 当 HOME是第一次启动 避免启动时，是一个空白的界面。
                synchronized (mLock) {
    ...
    public boolean isThisLauncher(Launcher launcher) {
        Callbacks cb = mCallbacks != null ? mCallbacks.get() : null;
        Log.i(TAG, "is This Launcher? launcher is " + launcher + " model launcher is " + cb
                + " same? " + (cb == launcher));
        return cb == null ? false : cb == launcher;
    }
}
