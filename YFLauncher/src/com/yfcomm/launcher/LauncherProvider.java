...
import com.yfcomm.launcher.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.yfcomm.launcher.settings";
    ...
    private static boolean LAUNCHER_MMX_SHORTCUT_ENABLED;
    private static boolean LAUNCHER_SFR_SHORTCUT_ENABLED;
    ...
    synchronized public void loadDefaultFavoritesIfNecessary(int origWorkspaceResId,
        ...
        if (dbCreatedNoWorkspace || overridePrevious) {
            ...
            if (workspaceResId == 0) {
                if (LAUNCHER_MMX_SHORTCUT_ENABLED) {
                    workspaceResId = sp.getInt(DEFAULT_WORKSPACE_RESOURCE_ID,
                            R.xml.mmx_default_workspace);
                } else if (LAUNCHER_SFR_SHORTCUT_ENABLED) {
                    workspaceResId = sp.getInt(DEFAULT_WORKSPACE_RESOURCE_ID,
                            R.xml.srf_default_workspace);
                } else if (LAUNCHER_BACKUP_SHORTCUT_ENABLED) {
                    workspaceResId = sp.getInt(DEFAULT_WORKSPACE_RESOURCE_ID,
                            R.xml.cm_with_backup_default_workspace);
                } else if (getContext().getResources().getBoolean(
                            R.bool.config_telcel_homescreen_enabled)) {
                    workspaceResId = sp.getInt(DEFAULT_WORKSPACE_RESOURCE_ID,
                            R.xml.latam_op_one_default_workspace);
                } else if (getContext().getResources().getBoolean(
                            R.bool.config_claro_homescreen_enabled)) {
                    workspaceResId = sp.getInt(DEFAULT_WORKSPACE_RESOURCE_ID,
                            R.xml.latam_op_two_default_workspace);
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        DatabaseHelper(Context context) {
            ...
            LAUNCHER_MMX_SHORTCUT_ENABLED = context.getResources().getBoolean(
                    R.bool.config_mmx_enabled);
            LAUNCHER_SFR_SHORTCUT_ENABLED = context.getResources().getBoolean(
                    R.bool.config_srf_enabled);
