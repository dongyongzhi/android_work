 ...
 * 
 * <a href="http://my.oschina.net/arthor" target="_blank" rel=
 * "nofollow">@author</a> antoine vianey
 *
 */
	...
	public static class Builder {
		...
		public CustomDialog create(int id) {
			...
			if (id != 0) {
				...
				LinearLayout ly = ((LinearLayout) layout.findViewById(R.id.custom_title));
				ImageView iv = ((ImageView) layout.findViewById(R.id.promptinfo));
				iv.setImageDrawable(context.getResources().getDrawable(id));
				ly.setBackground(layout.getResources().getDrawable(R.drawable.bg_title_custom_dialog));	
			...
			if (message != null) {
				TextView cTextView=((TextView) layout.findViewById(R.id.message));
				if(id!=0)
					cTextView.setText(message);
				else{
					cTextView.setText(message);
					cTextView.setTextColor(layout.getResources().getColor(R.color.white));
				}
