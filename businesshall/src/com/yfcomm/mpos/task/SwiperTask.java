...
import com.yfcomm.mpos.codec.StringUtils;
...
public class SwiperTask extends AsyncTask<Void,Object,Integer>{
	...
	private final MyDeviceComm deviceComm;
	...
	public SwiperTask(MyDeviceComm deviceComm,OpenReadCard openReadCard, DeviceContext context,SwiperTaskListener listener) {
	...
	public MyDeviceComm getDeviceComm() {
		return deviceComm;
	}
