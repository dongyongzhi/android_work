...
public class PackagesTools {
	...
	public int GetPackageIsSystem(String packageName) {
		try {
			PackageInfo info = pm.getPackageInfo(packageName, 0);
			return info.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM;
		} catch (Exception e) {
	...
	public WinInfo GetPackageInfo(String packageName) {
		...
		try {
			...
			//app.isSystem = info.applicationInfo.flags & ApplicationInfo.FLAG_SYSTEM;
			return app;
